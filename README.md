...
* Build status: [![testsuite](https://github.com/petdance/test-www-mechanize/actions/workflows/testsuite.yml/badge.svg?branch=dev)](https://github.com/petdance/test-www-mechanize/actions/workflows/testsuite.yml)
* cpantesters.org:
